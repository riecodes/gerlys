...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2024 at 11:29 AM
...
INSERT INTO `menu` (`menu_id`, `menu_name`, `menu_description`, `menu_price`) VALUES
(1, 'Grilled Chicken Sandwich', 'A delicious grilled chicken sandwich with fresh lettuce, tomatoes, and mayonnaise on a toasted bun', 7.99);
...
(3, 2, 1, 1, '2024-10-26 17:25:00', 'naic', 'pending', '2024-10-26 09:26:13', '2024-10-26 09:26:13'),
(4, 2, 1, 1, '2024-10-26 17:25:00', 'naic', 'pending', '2024-10-26 09:26:26', '2024-10-26 09:26:26');
...
INSERT INTO `service` (`service_id`, `service_name`, `service_description`, `service_price`) VALUES
(1, 'Weddings', 'Comprehensive wedding planning and coordination to make your special day memorable. Our team assists with venue selection, decor, catering, and guest management, ensuring a flawless celebration.', 1200.00);
...
(7, 'Admin', 'Admin', 'admin@gmail.com', '09124', 'admin', '1', NULL, NULL, '', '');
