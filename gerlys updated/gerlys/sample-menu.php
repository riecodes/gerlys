                    ...
                    <div class="card-container my-5">
                        ...
                        <div class="card" style="border-radius: 10px; border: none;">
                            ...
                            <div class="card-body">
                                ...
                                <img src="image/samplecoffejelly.webp" alt="">
    
                                <div class="card-titles">
    
                                    <h4 class="card-title">Coffee Jelly</h4>
                                    <h4 class="card-text">₱800.00</h4>
